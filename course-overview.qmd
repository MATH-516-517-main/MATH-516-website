...
Apart from the topics mentioned [in the schedule](index.qmd), mastering this course requires scripting (simulation studies and data exploration & visualization tasks), as well as sharing your code via **GitHub**. Check out [this manual](https://math-516-517-main.github.io/math_517_website/resources/tutorials/github.html) from the previous course (MATH-517, a **mandatory prerequisite**). **Exercise classes should be attended** and used to pick up the required skills, and work on the projects!
